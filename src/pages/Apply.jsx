    ...
    <>
      ...
      <div className="content">
        <div className="write-box">
          <button className="close-button" onClick={handleClose}>X</button>
          <div className="sepa-line"></div>
          <div className="apply-title">{data.title} - 지원하기</div>

          <div className="apply-form">
            <div className="apply-form-group">
              <label className="apply-label">학과</label>
              <input
  type="text"
...
/>
              ...
              <label className="apply-label">이름</label>
              <input
  type="text"
  className="apply-input"
  value={name}
...
/>
          ...
          <div className="apply-form-group motivation-group">
  <label className="apply-label motivation-label">지원 동기</label>
  <textarea
  className="apply-input motivation-input"
...
{portfolioLinks.map((link, idx) => (
  <div className="apply-form-group portfolio-group" key={`portfolio-${idx}`}>
    {idx === 0 ? (
      <label className="apply-label portfolio-label">
        포트폴리오 링크 (프로젝트 지원자만)
      </label>
    ) : (
    ...
    <input
      type="text"
      className="apply-input portfolio-input"
      value={link}
      onChange={(e) => {
...
{techStacks.map((stack, idx) => (
  <div className="apply-form-group stack-group" key={`stack-${idx}`}>
    {idx === 0 ? (
      <label className="apply-label stack-label">
    ...
    <input
      type="text"
      className="apply-input stack-input"
      value={stack}
      onChange={(e) => {
